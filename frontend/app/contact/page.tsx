...
export const metadata: Metadata = {
  title: "Contact Us - Get in Touch | Quantum Arc Labs",
  description:
    "Contact Quantum Arc Labs for your software development needs. We respond within 24 hours. Email: quantumarc.labs@gmail.com",
};
