...
export const metadata: Metadata = {
  metadataBase: new URL("https://quantumarclabs.com"),
  title: {
    default: "Quantum Arc Labs - Building the Future of Software",
    template: "%s | Quantum Arc Labs",
  },
  description:
    "Leading software development company specializing in web development, mobile apps, and innovative digital solutions.",
  keywords: [
  ...
  authors: [{ name: "Quantum Arc Labs" }],
  creator: "Quantum Arc Labs",
  publisher: "Quantum Arc Labs",
  robots: {
    index: true,
    follow: true,
  },
